...
| | `mp_tak2_to_hub`、`mp_hub_to_tak2`、`mp_v51_to_hub`、`mp_hub_to_v51`、`mp_cmv12_to_hub`、`mp_hub_to_cmv12`、`mp_v4_to_hub`、`mp_hub_to_v4` | 中心（MpTak_v7.1）との minimap2 のアライメント（spec-ingest §20）。cmMarPoly1.2 だけ `asm20` | |
